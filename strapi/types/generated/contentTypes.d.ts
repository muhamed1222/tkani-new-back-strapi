...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0411\u0430\u043D\u043D\u0435\u0440\u044B \u0434\u043B\u044F \u0441\u043B\u0430\u0439\u0434\u0435\u0440\u043E\u0432 \u043D\u0430 \u0433\u043B\u0430\u0432\u043D\u043E\u0439 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0435';
    displayName: '\u0411\u0430\u043D\u043D\u0435\u0440\u044B';
    pluralName: 'banners';
    singularName: 'banner';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['clothing', 'home']> &
      Schema.Attribute.Required &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['clothing', 'home', 'furniture']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'clothing'>;
...
export interface ApiNotificationRecipientNotificationRecipient
  ...
  info: {
    description: '\u0421\u043F\u0438\u0441\u043E\u043A \u043F\u043E\u043B\u0443\u0447\u0430\u0442\u0435\u043B\u0435\u0439 Telegram-\u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0439 \u043E \u043D\u043E\u0432\u044B\u0445 \u0437\u0430\u043A\u0430\u0437\u0430\u0445';
    displayName: '\u041F\u043E\u043B\u0443\u0447\u0430\u0442\u0435\u043B\u0438 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0439';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    telegram_chat_id: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_comment: Schema.Attribute.Text;
    customer_company: Schema.Attribute.String;
    customer_email: Schema.Attribute.Email & Schema.Attribute.Required;
    customer_firstName: Schema.Attribute.String;
    customer_lastName: Schema.Attribute.String;
    customer_middleName: Schema.Attribute.String;
    ...
    delivery_city: Schema.Attribute.String;
    delivery_method: Schema.Attribute.Enumeration<
      ['pickup', 'russian_post', 'cdek', 'ozon']
    >;
    delivery_postcode: Schema.Attribute.String;
    delivery_price: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    delivery_type: Schema.Attribute.Enumeration<['pickup', 'delivery']> &
      Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_comments: Schema.Attribute.Text;
    ...
    payment_method: Schema.Attribute.Enumeration<
      ['card', 'cash', 'invoice', 'yookassa', 'cloudpayments']
    > &
      Schema.Attribute.Required;
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    displayName: '\u0420\u0430\u0431\u043E\u0442\u044B \u0438\u0445 \u043D\u0430\u0448\u0438\u0445 \u0442\u043A\u0430\u043D\u0435\u0439';
    pluralName: 'works';
    singularName: 'work';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    fabrics: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
